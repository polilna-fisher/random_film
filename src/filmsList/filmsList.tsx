            ...
            <div className='film_container_common'>
                ...
                <div className='film_parameters_container'>
                    ...
                    <div
                        className='film_text'>
                        <span
                            className='film_text_bold'>Рейтинг: </span>
